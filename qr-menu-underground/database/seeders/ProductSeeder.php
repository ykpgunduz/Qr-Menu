...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $products = [
            ...
            ['title' => 'Sıcak Çikolata Çeşitleri', 'price' => 145.00, 'category' => 'Sıcak İçecekler'],
            ...
            ['title' => 'Corn Flakes Çeşitleri Karışık-Yulaf-Kırmızı Meyveli', 'price' => 100.00, 'category' => 'Atıştırmalıklar'],
