                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="w-100 d-flex flex-column text-start ps-4">
                                        ...
                                        <p class="d-flex justify-content-between">
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;"><i class="fa-solid fa-cart-plus"></i></button>
                                        </p>
                                    </div>
                                </div>
                            </div>
