(() => {
    ...
    var j = (i, t, e, s) => {
        if (t && typeof t == "object" || typeof t == "function")
            for (let n of Y(t)) !W.call(i, n) && n !== e && N(i, n, { get: () => t[n], enumerable: !(s = V(t, n)) || s.enumerable });
        return i;
    };

    var J = (i, t, e) => (e = i != null ? O(H(i)) : {}, j(t || !i || !i.__esModule ? N(e, "default", { value: i, enumerable: !0 }) : e, i));
    var S = d((ut, _) => {
    ...
    var R = d((lt, F) => {
        var Q = S(), X = C(), a = Q(), Z = [a[0] | 1, a[1], a[2], a[3], a[4], a[5]], b = (a[6] << 8 | a[7]) & 16383, D = 0, A = 0;

        function tt(i, t, e) {
            var s = t && e || 0;
            i = i || {};
            var n = i.clockseq !== void 0 ? i.clockseq : b, o = i.msecs !== void 0 ? i.msecs : new Date().getTime(), h = i.nsecs !== void 0 ? i.nsecs : A + 1, l = o - D + (h - A) / 1e4;
            if (l < 0 && i.clockseq === void 0 && (n = n + 1 & 16383), (l < 0 || o > D) && i.nsecs === void 0 && (h = 0), h >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
            D = o, A = h, b = n, o += 122192928e5;

            var c = ((o & 268435455) * 1e4 + h) % 4294967296;
            n[s++] = c >>> 24 & 255, n[s++] = c >>> 16 & 255, n[s++] = c >>> 8 & 255, n[s++] = c & 255;

            var u = o / 4294967296 * 1e4 & 268435455;
            n[s++] = u >>> 8 & 255, n[s++] = u & 255, n[s++] = u >>> 24 & 15 | 16, n[s++] = u >>> 16 & 255, n[s++] = n >>> 8 | 128, n[s++] = n & 255;
    ...
    var q = i => {
        i.data("notificationComponent", ({ notification: t }) => ({
            ...
            init: function() {
                ...
                t.duration && t.duration !== "persistent" && setTimeout(() => {
            ...
            configureAnimations: function() {
                ...
                Livewire.hook("commit", ({ component: s, commit: n, succeed: r, fail: o, respond: h }) => {
                    ...
                    h(() => {
                        e = () => {
                            this.isShown && this.$el.animate([{ transform: `translateY(${c - l()}px)` }, { transform: "translateY(0px)" }], { duration: this.transitionDuration, easing: this.transitionEasing });
            ...
            close: function() {
                this.isShown = !1,
                setTimeout(() => window.dispatchEvent(new CustomEvent("notificationClosed", { detail: { id: t.id } })), this.transitionDuration);
            },
            markAsRead: function() {
